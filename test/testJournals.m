...
AddTest[journalFileHandlingTests, "testReadJournal",
 AssertMessage[Message[Import::nffil], ReadJournal["notAFile"]];
 ...
 WriteToJournal[filename, journal];
 AssertTrue[FileExistsQ[filename]];
 
  With[{journalRead = ReadJournal[filename]},
